function REXData=RexProcessStandalone(rexName, Spike2Replace)
...
% data. 
% If Spike2Replace==1, loads data exported from Spike2 and adds/replaces 
% spike times, unit IDs and waveforms
% Data is written to a ‘.mat’ file using the name of the Rex files
% given.  (Thus ‘mydataA’ and ‘mydataE’ become ‘mydata.mat’.) 
